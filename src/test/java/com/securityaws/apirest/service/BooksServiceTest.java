...
import com.securityaws.apirest.unittests.mapper.mocks.MockBook;
...
class BooksServiceTest {
    ...
    void getByidBooks() {
        ...
        var result = service.getByidBooks(1L);
    ...
    void createBooks() {
        ...
        var result = service.createBooks(vo);

        assertNotNull(result);
        assertNotNull(result.getKey());
        assertNotNull(result.getLinks());

        assertNotNull(result.toString().contains("links: [</api/books/v1>;rel=\"self\"]"));
        assertEquals("Some Author1", result.getAuthor());
        assertEquals("Some Title1", result.getTitle());
        assertEquals(25D, result.getPrice());
        assertNotNull(result.getLaunchDate());
    ...
    void updateBooks() {
        ...
        var result = service.updateBooks(vo);
